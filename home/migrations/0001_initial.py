# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-05-10 02:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', models.ForeignKey(db_column='pid', max_length=20, on_delete=django.db.models.deletion.CASCADE, to='home.Product')),
            ],
            options={
                'db_table': 't_shop_car',
            },
        ...
        migrations.AddField(
            model_name='shopcar',
            name='uid',
            field=models.ForeignKey(db_column='uid', max_length=10, on_delete=django.db.models.deletion.CASCADE, to='home.User'),
        ),
        migrations.AddField(
            model_name='review',
            name='uid',
